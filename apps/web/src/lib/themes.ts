...
export const themes: Theme[] = [
  ...
  {
    name: 'executive-red',
    displayName: 'Executive Red',
    description: 'Dark theme with bold crimson accents',
    colors: {
      primary: '#dc2626',
      secondary: '#7c3aed',
      accent: '#dc2626',
  ...
  {
    name: 'growth-green',
    displayName: 'Growth Green',
    description: 'Nature-inspired dark theme with emerald accents',
    colors: {
      primary: '#16a34a',
      secondary: '#0891b2',
      accent: '#22c55e',
