...
import { Home, MessageCircle, HelpCircle, GraduationCap, Calendar, Users, Settings, Shield, LogOut, ChevronRight, Mail, X, Play, Search, Compass, Star, BookOpen, BarChart3, UsersRound, Bookmark } from 'lucide-react';
